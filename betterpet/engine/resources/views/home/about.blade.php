...
<div class='container-fluid page-wrap' id="page-wrap">
    ...
    <div class="row">
        <div class="team hidden-xs">
            ...
            <div class="team">
                <div class="row team-row" style="margin-top: 6%;" >
                    <div class="col-xs-3  col-md-2 col-md-offset-3 col-sm-offset-2">
                ...
                <div class="row team-row">
                    <div class="col-xs-6  col-md-4 col-md-offset-3 col-sm-offset-2">
                        <h3>Faiz Kautsar</h3>
                        <blockquote><i>
        ...
        <div class="team hidden-sm hidden-md hidden-lg">
            <h1 class="text-center font-header">Meet the team</h1>
            <hr class="line">
            <div class="team">
                <div class="row team-row" style="margin-top: 6%;" >
